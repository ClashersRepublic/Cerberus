...
namespace CRepublic.Royale.Files.CSV_Logic
{
    ...
    {
        internal Characters(Row _Row, DataTable _DataTable) : base(_Row, _DataTable)
        {
            Load(_Row);
        }

        // NOTE: This was generated from the characters.csv using gen_csv_properties.py script.
        ...
        /// <summary>
        /// Gets or sets Spawn angle shift.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets Attack dash time.
        /// </summary>
        public int AttackDashTime { get; set; }

        /// <summary>
        /// Gets or sets Looping filter.
        /// </summary>
