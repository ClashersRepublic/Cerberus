...
{
    internal class Tutorial_NPC : Data
    {
        internal Tutorial_NPC(Row _Row, DataTable _DataTable) : base(_Row, _DataTable)
        {
            Load(_Row);
        }

        // NOTE: This was generated from the tutorials_npc.csv using gen_csv_properties.py script.
