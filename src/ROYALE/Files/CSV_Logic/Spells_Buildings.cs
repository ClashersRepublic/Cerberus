...
namespace CRepublic.Royale.Files.CSV_Logic
{
    ...
    {
        internal Spells_Buildings(Row _Row, DataTable _DataTable) : base(_Row, _DataTable)
        {
            Load(_Row);
        }

        // NOTE: This was generated from the spells_buildings.csv using gen_csv_properties.py script.
