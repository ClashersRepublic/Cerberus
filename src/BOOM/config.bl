<appSettings>
  ...
  <add key="startingGems" value="999999999" />
  <add key="startingGold" value="999999999" />
  <add key="startingWood" value="999999999" />
  <add key="startingStone" value="999999999" />
  <add key="startingMetal" value="999999999" />
  ...
  <add key="MysqlDatabase" value="CRepublic.Boom" />
  <!--  Redis server password-->
