...
using Resource = BL.Servers.BB.Files.CSV_Logic.Resource;
    ...
    internal class ConstructionItem : GameObject
    {
        ...
        public bool CanUpgrade()
        {
            ...
            if (!IsConstructing)
            {
                if (UpgradeLevel < GetConstructionItemData().GetUpgradeLevelCount() - 1)
                {
                    ...
                    {
                         int currentTownHallLevel = this.Level.Avatar.HQ_Level;
        ...
        public void StartConstructing(Vector vector)
        {
            ...
            else
            {
                ...
                //this.Timer.WorkerManager.AllocateWorker(this);
                this.IsConstructing = true;
            }
        }
        ...
        {
            UpgradeLevel = level;
            if (GetConstructionItemData().IsHQ())
            {
                this.Level.Avatar.HQ_Level = level;
            }
