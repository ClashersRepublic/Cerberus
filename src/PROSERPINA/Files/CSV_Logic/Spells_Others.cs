...
{
    internal class Spells_Others : Data
    {
        internal Spells_Others(Row _Row, DataTable _DataTable) : base(_Row, _DataTable)
        {
            Load(_Row);
        }

        // NOTE: This was generated from the spells_other.csv using gen_csv_properties.py script.
