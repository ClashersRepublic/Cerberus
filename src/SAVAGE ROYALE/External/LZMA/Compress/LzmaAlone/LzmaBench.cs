using System;
using System.IO;
using CRepublic.Royale.External.LZMA.Common;
using CRepublic.Royale.External.LZMA.Compress.LZMA;

namespace CRepublic.Royale.External.LZMA.Compress.LzmaAlone
{
    /// <summary>
    /// LZMA Benchmark
    /// </summary>
